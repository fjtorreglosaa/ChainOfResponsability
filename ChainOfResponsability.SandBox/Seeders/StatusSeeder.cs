...
namespace ChainOfResponsability.SandBox.Seeders
{
    ...
    {
        public static Status SUBMITTED = new Status
        {
        ...
        public static Status RECEIVED = new Status
        {
        ...
        public static Status IN_PREPARATION = new Status
        {
        ...
        public static Status PREPARED = new Status
        {
        ...
        public static Status ON_ASSIGNMENT = new Status
        {
        ...
        public static Status ASSIGNED = new Status
        {
        ...
        public static Status COLLECTED = new Status
        {
        ...
        public static Status ON_ROUTE = new Status
        {
        ...
        public static Status DELIVERED = new Status
        {
        ...
        public static Status ACCEPTED = new Status
        {
        ...
        public static Status ORDER_CANCELLED = new Status
        {
        ...
        public static Status INVOICE_CANCELLED = new Status
        {
        ...
        public static Status INVOICED = new Status
        {
        ...
        public static Status PORTFOLIO_IMPAIRMENT = new Status
        {
        ...
        public static Status OVERDUE = new Status
        {
        ...
        public static Status PAID = new Status
        {
        ...
        public static void Seed()
        {
            ...
            {
               SUBMITTED, RECEIVED, IN_PREPARATION, PREPARED, ON_ASSIGNMENT,
               ASSIGNED, COLLECTED, ON_ROUTE, DELIVERED, ACCEPTED, ORDER_CANCELLED, 
               INVOICED, PORTFOLIO_IMPAIRMENT, OVERDUE, PAID
            };
